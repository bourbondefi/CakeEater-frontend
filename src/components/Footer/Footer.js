      ...
      <Container maxWidth="lg">
        <Grid container>
          ...
          <Grid item xs={6} style={{textAlign: 'right', height: '20px'}}>
            ...
            <a href="https://github.com/bourbondefi" rel="noopener noreferrer" target="_blank" className={classes.link}>
              <IconGithub style={{fill: '#dddfee', height: '20px'}} />
            </a>
            <a href="https://t.me/bourbondao" rel="noopener noreferrer" target="_blank" className={classes.link}>
              <IconTelegram style={{fill: '#dddfee', height: '20px'}} />
            </a>
            <a href="https://discord.gg/xjg7wdnUeT" rel="noopener noreferrer" target="_blank" className={classes.link}>
